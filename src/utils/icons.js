...
export function IconUserCheck(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path
        d="M8 12.052c1.995 0 3.5-1.505 3.5-3.5s-1.505-3.5-3.5-3.5s-3.5 1.505-3.5 3.5s1.505 3.5 3.5 3.5zM9 13H7c-2.757 0-5 2.243-5 5v1h12v-1c0-2.757-2.243-5-5-5zm11.294-4.708l-4.3 4.292l-1.292-1.292l-1.414 1.414l2.706 2.704l5.712-5.702z"
        fill="currentColor"
      ></path>
    </svg>
  );
...
export function IconBankFill(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 256 256" {...props}>
      <path
        fill="currentColor"
        d="M248 208a8 8 0 0 1-8 8H16a8 8 0 0 1 0-16h224a8 8 0 0 1 8 8ZM16.3 98.2a8 8 0 0 1 3.5-9l104-64a7.9 7.9 0 0 1 8.4 0l104 64A8 8 0 0 1 232 104h-24v64h16a8 8 0 0 1 0 16H32a8 8 0 0 1 0-16h16v-64H24a8 8 0 0 1-7.7-5.8ZM144 160a8 8 0 0 0 16 0v-48a8 8 0 0 0-16 0Zm-48 0a8 8 0 0 0 16 0v-48a8 8 0 0 0-16 0Z"
      ></path>
    </svg>
  );
}
  ...
  return (
    <svg width="1em" height="1em" viewBox="0 0 48 48" {...props}>
      <path
        ...
        d="M25.91 39a2.24 2.24 0 0 0 2.24 2.24h13.11A2.24 2.24 0 0 0 43.5 39V9a2.24 2.24 0 0 0-2.24-2.24H28.15A2.24 2.24 0 0 0 25.91 9Zm-3.29-22.3a1.81 1.81 0 0 0-1.8-1.81H8.3a1.8 1.8 0 0 0-1.8 1.81V36a1.8 1.8 0 0 0 1.8 1.81h12.52a1.81 1.81 0 0 0 1.8-1.81Zm-8.06 6.56a3.1 3.1 0 0 0-3.1 3.11h0a3.1 3.1 0 0 0 3.1 3.1h0a3.1 3.1 0 0 0 3.1-3.1h0a3.1 3.1 0 0 0-3.1-3.11Zm20.15 0a3.1 3.1 0 0 0-3.11 3.1h0a3.11 3.11 0 1 0 3.11-3.11Zm-24.09-6.12h6.88m13.76-7.61h6.89m-6.87 29.32h6.88"
      ></path>
      <path
        fill="currentColor"
        d="M40.2 8.78a.72.72 0 1 1-.06 0Zm-20.65 7.61h.05a.75.75 0 1 1-.75.75a.76.76 0 0 1 .7-.75Z"
      ></path>
      <path
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6.5 19.18h16.12M6.5 34.55h16.12m-4.96-8.21H31.6m-5.69 10.11H43.5M25.91 12.04H43.5"
      ></path>
    </svg>
  );
}
...
export function IconLongLeft(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path fill="currentColor" d="M6 16v-3h16v-2H6V8l-4 4l4 4Z"></path>
    </svg>
  );
}
  ...
  return (
    <svg width="1em" height="1em" viewBox="0 0 48 48" {...props}>
      <g
        ...
        strokeWidth="4"
      >
        <path d="M6 9a3 3 0 0 1 3-3h30a3 3 0 0 1 3 3v30a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3V9Z"></path>
        <path
          strokeLinecap="round"
...
export function IconSpinner(props) {
  return (
    <svg width="1.05em" height="1em" viewBox="0 0 25 24" {...props}>
      <path
        fill="currentColor"
